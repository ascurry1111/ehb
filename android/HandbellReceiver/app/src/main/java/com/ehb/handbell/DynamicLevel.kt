...
enum class DynamicLevel(
    ...
    PIANISSIMO(  "pp", "Pianissimo",   2.1667f,          1.8833f, 0.080f),
    PIANO(       "p",  "Piano",        2.7333f,          2.4500f, 0.133f),
    MEZZO_PIANO( "mp", "Mezzo-piano",  3.3000f,          3.0167f, 0.220f),
    MEZZO_FORTE( "mf", "Mezzo-forte",  3.8667f,          3.5833f, 0.364f),
    FORTE(       "f",  "Forte",        4.4333f,          4.1500f, 0.603f),
    ...
    // levels, 0.08 -> 1.00) rather than evenly, since perceived loudness is
    // roughly logarithmic -- equal linear steps would sound bunched up at the
    // loud end. That's ~22dB of range pp-to-ff, comparable to real acoustic
    // dynamic range, and previously there was ~0dB of difference (see below).
